/*
  This file is a slightly modified version of getcycles.c 
  https://github.com/ascon/ascon-c/blob/main/tests/getcycles.c
*/
...
/*
  * Bench function (changes getcycles' main function)
  * Instructions about the frequency factor is in the ascon-c readme
*/

int bench(int frequency_factor) {
  unsigned long long i, j;
  double factor = 1.0;
  if (frequency_factor != 0) factor = frequency_factor;
